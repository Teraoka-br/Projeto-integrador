...
export default function MenuCentral() {
  return (
    <div class="grid" >
      ...
      <div class="g-col-4"><MenuCentralItem icone={engrenagem} titulo="Cliente"/></div>

      <div class="g-col-4"><MenuCentralItem icone={processos} titulo="Cliente"/></div>
      <div class="g-col-4"><MenuCentralItem icone={tarefas} titulo="Cliente"/></div>
